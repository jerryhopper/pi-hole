...
webInterfaceGitUrl="https://github.com/jerryhopper/pi-hole/AdminLTE.git"
webInterfaceDir="${webroot}/admin"
piholeGitUrl="https://github.com/jerryhopper/pi-hole/pi-hole.git"
...
main() {
    ...
    # Otherwise,
        ...
        if is_command sudo ; then
            ...
            exec curl -sSL https://raw.githubusercontent.com/jerryhopper/pi-hole/master/automated%20install/basic-install.sh | sudo bash "$@"
            exit $?
        # Otherwise,
        else
